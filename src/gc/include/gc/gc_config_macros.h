...
#elif defined(__LP64__) || defined(_LP64) || defined(_WIN64) || defined(__alpha__) || defined(__arch64__) || defined(__powerpc64__) || defined(__s390x__) || defined(__sparcv9) || (defined(__x86_64__) && !defined(__ILP32__))
...
#if defined(__clang__) && defined(__CYGWIN__) && defined(GC_THREADS) && defined(__LP64__)
...
#include <stddef.h>
#if defined(__MINGW32__) && !defined(_WIN32_WCE) || defined(__CHERI_PURE_CAPABILITY__)
#include <stdint.h>
...
#if defined(GC_HAVE_BUILTIN_BACKTRACE) && !defined(GC_CAN_SAVE_CALL_STACKS) || defined(__sparc)
#define GC_CAN_SAVE_CALL_STACKS
#endif
...
#if (defined(GC_DARWIN_THREADS) || defined(GC_WIN32_PTHREADS) || defined(__native_client__)) && !defined(GC_NO_PTHREAD_SIGMASK)
...
#if !defined(GC_HAVE_PTHREAD_EXIT) && ((defined(GC_LINUX_THREADS) && !defined(HOST_ANDROID) && !defined(__ANDROID__)) || defined(GC_SOLARIS_THREADS) || defined(__COSMOPOLITAN__))
