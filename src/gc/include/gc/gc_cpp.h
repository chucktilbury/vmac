...
#if !defined(GC_NO_OPERATOR_NEW_ARRAY) && !defined(_ENABLE_ARRAYNEW) /* Digimars */ \
        && (defined(__BORLANDC__) && (__BORLANDC__ < 0x450) || (defined(__GNUC__) && !GC_GNUC_PREREQ(2, 6)) || (defined(_MSC_VER) && _MSC_VER <= 1020) || (defined(__WATCOMC__) && __WATCOMC__ < 1050))
...
#if !defined(GC_NO_INLINE_STD_NEW) && !defined(GC_INLINE_STD_NEW) && (defined(_MSC_VER) || defined(__DMC__) || ((defined(__BORLANDC__) || defined(__CYGWIN__) || defined(__CYGWIN32__) || defined(__MINGW32__) || defined(__WATCOMC__)) && !defined(GC_BUILD) && !defined(GC_NOT_DLL)))
...
#if (!defined(__BORLANDC__) || __BORLANDC__ > 0x0620) && !defined(__sgi) && !defined(__WATCOMC__) && (!defined(_MSC_VER) || _MSC_VER > 1020)
#define GC_PLACEMENT_DELETE
#endif

#if !defined(GC_OPERATOR_SIZED_DELETE) && !defined(GC_NO_OPERATOR_SIZED_DELETE) && (__cplusplus >= 201402L || _MSVC_LANG >= 201402L) // C++14
#define GC_OPERATOR_SIZED_DELETE
#endif

#if !defined(GC_OPERATOR_NEW_NOTHROW) && !defined(GC_NO_OPERATOR_NEW_NOTHROW) && ((defined(GC_INCLUDE_NEW) && (__cplusplus >= 201103L || _MSVC_LANG >= 201103L)) || defined(__NOTHROW_T_DEFINED))
...
#if !defined(GC_NEW_DELETE_THROW_NOT_NEEDED) && !defined(GC_NEW_DELETE_NEED_THROW) && GC_GNUC_PREREQ(4, 2) && (__cplusplus < 201103L || defined(__clang__))
...
// from gc_cleanup.
inline void* operator new(GC_SIZE_T, GC_NS_QUALIFY(GCPlacement), GC_NS_QUALIFY(GCCleanUpFunc) = 0, void* /* clientData */ = 0);

#ifdef GC_PLACEMENT_DELETE
inline void operator delete(void*, GC_NS_QUALIFY(GCPlacement), GC_NS_QUALIFY(GCCleanUpFunc), void*) GC_NOEXCEPT;
#endif
...
inline void*
        operator new(GC_SIZE_T size, int /* nBlockUse */, const char* szFileName, int nLine) {
#ifdef GC_DEBUG
...
void* operator new[](GC_SIZE_T, int /* nBlockUse */, const char* /* szFileName */, int /* nLine */);
#endif // GC_OPERATOR_NEW_ARRAY
...
namespace boehmgc {
    ...
    inline void GC_CALLBACK
        ...
        reinterpret_cast<gc_cleanup*>(
                reinterpret_cast<char*>(obj) + static_cast<GC_PTRDIFF_T>(reinterpret_cast<GC_uintptr_t>(displ)))
                ->~gc_cleanup();
    }
        ...
        if(base != 0) {
            ...
            GC_register_finalizer_ignore_self(
                    ...
                    reinterpret_cast<void*>(
                            static_cast<GC_uintptr_t>(reinterpret_cast<char*>(this_ptr) - reinterpret_cast<char*>(base))),
                    &oldProc, &oldData);
            if(oldProc != 0) {
...
inline void*
        operator new(GC_SIZE_T size, GC_NS_QUALIFY(GCPlacement) gcp, GC_NS_QUALIFY(GCCleanUpFunc) cleanup, void* clientData) {
    void* obj;
    switch(gcp) {
...
#ifdef GC_PLACEMENT_DELETE
inline void
        operator delete(void* obj, GC_NS_QUALIFY(GCPlacement), GC_NS_QUALIFY(GCCleanUpFunc), void* /* clientData */) GC_NOEXCEPT {
    GC_FREE(obj);
}
#endif // GC_PLACEMENT_DELETE
