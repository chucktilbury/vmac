...
#define GC_MARK_AND_PUSH(obj, msp, lim, src) \
    (GC_ADDR_LT((char*)GC_least_plausible_heap_addr, (char*)(obj)) && GC_ADDR_LT((char*)(obj), (char*)GC_greatest_plausible_heap_addr) ? GC_mark_and_push(obj, msp, lim, src) : (msp))
...
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL
        GC_debug_generic_or_special_malloc(size_t /* size */, int /* knd */, GC_EXTRA_PARAMS);
