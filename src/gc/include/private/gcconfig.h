...
#if (defined(linux) || defined(__linux__) || defined(HOST_ANDROID) || defined(HOST_TIZEN)) && !defined(LINUX) && !defined(__native_client__)
#define LINUX
#endif
...
#endif
#endif
#if defined(__aarch64__) && !defined(ANY_BSD) && !defined(COSMO) && !defined(DARWIN) && !defined(LINUX) && !defined(KOS) && !defined(NN_BUILD_TARGET_PLATFORM_NX) && !defined(QNX) && !defined(SERENITY) && !defined(_WIN32)
#define AARCH64
#define NOSYS
#define mach_type_known
#endif
...
#define mach_type_known
#elif !defined(ANY_BSD) && !defined(DARWIN) && !defined(LINUX) && !defined(QNX) && !defined(NN_PLATFORM_CTR) && !defined(SN_TARGET_PSP2) && !defined(_WIN32) && !defined(__CEGCC__) && !defined(GC_NO_NOSYS)
#define NOSYS
#define mach_type_known
#endif
#endif
...
#define mach_type_known
#endif
#if (defined(mips) || defined(__mips) || defined(_mips)) && !defined(__TANDEM) && !defined(ANY_BSD) && !defined(LINUX)
#define MIPS
...
#define SOLARIS
#define mach_type_known
#elif defined(sparc) && defined(unix) && !defined(sun) && !defined(linux) && !defined(ANY_BSD)
#define SPARC
#define DRSNX
#define mach_type_known
#endif
...
#define mach_type_known
#else
#if ((defined(_MSDOS) || defined(_MSC_VER)) && (_M_IX86 >= 300)) || (defined(_WIN32) && !defined(__CYGWIN32__) && !defined(__CYGWIN__) && !defined(__INTERIX) && !defined(SYMBIAN)) || defined(__MINGW32__)
...
#if defined(__aarch64__) && (defined(ANY_BSD) || defined(COSMO) || defined(DARWIN) || defined(LINUX) || defined(KOS) || defined(QNX) || defined(SERENITY))
#define AARCH64
#define mach_type_known
#elif defined(__arc__) && defined(LINUX)
#define ARC
#define mach_type_known
#elif (defined(__arm) || defined(__arm__) || defined(__arm32__) || defined(__ARM__)) && (defined(ANY_BSD) || defined(DARWIN) || defined(LINUX) || defined(QNX) || defined(NN_PLATFORM_CTR) || defined(SN_TARGET_PSP2))
#define ARM32
#define mach_type_known
...
#define HEXAGON
#define mach_type_known
#elif (defined(__i386__) || defined(i386) || defined(__X86__)) && (defined(ANY_BSD) || defined(DARWIN) || defined(EMBOX) || defined(LINUX) || defined(QNX) || defined(SERENITY))
#define I386
#define mach_type_known
...
#define M68K
#define mach_type_known
#elif (defined(__mips) || defined(_mips) || defined(mips)) && (defined(ANY_BSD) || defined(LINUX))
#define MIPS
#define mach_type_known
...
#define mach_type_known
#elif (defined(__powerpc__) || defined(__powerpc64__) || defined(__ppc__) || defined(__ppc64__) || defined(powerpc) || defined(powerpc64)) && (defined(ANY_BSD) || defined(DARWIN) || defined(LINUX))
#define POWERPC
#define mach_type_known
...
#define SH
#define mach_type_known
#elif (defined(__sparc) || defined(sparc)) && (defined(ANY_BSD) || defined(LINUX))
#define SPARC
#define mach_type_known
#elif defined(__sw_64__) && defined(LINUX)
#define SW_64
#define mach_type_known
#elif (defined(__x86_64) || defined(__x86_64__) || defined(__amd64__) || defined(__X86_64__)) && (defined(ANY_BSD) || defined(COSMO) || defined(DARWIN) || defined(LINUX) || defined(QNX) || defined(SERENITY))
#define X86_64
#define mach_type_known
#endif
...
#define PTR_ALIGN_UP(p, b) \
    ((ptr_t)(((GC_uintptr_t)(p) + (GC_uintptr_t)(b) - (GC_uintptr_t)1) & ~((GC_uintptr_t)(b) - (GC_uintptr_t)1)))
#endif
...
/* relevant registers onto the stack.                               */
        ...
        && !(defined(__clang__) && defined(__ARM_ARCH_5TE__) /* clang-19 emits vpush/vpop */) && (!defined(__clang__) || GC_CLANG_PREREQ(8, 0) /* was no-op in clang-3 at least */)
#define HAVE_BUILTIN_UNWIND_INIT
#endif

#if (defined(__CC_ARM) || defined(CX_UX) || defined(DJGPP) || defined(EMBOX) || defined(EWS4800) || defined(LINUX) || defined(OS2) || defined(RTEMS) || defined(UTS4) || defined(MSWIN32) || defined(MSWINCE) || (defined(NOSYS) && defined(RISCV))) && !defined(NO_UNDERSCORE_SETJMP)
...
#endif
#if !defined(GC_THREADS) || defined(NO_HANDLE_FORK) || defined(GC_NO_CAN_CALL_ATFORK)
#define MPROTECT_VDB
...
#if defined(FORCE_ALIGNMENT_ONE) && (defined(__BORLANDC__) || defined(__WATCOMC__))
#define ALIGNMENT 1
#endif
#ifdef SEQUENT
...
#define DATASTART2 \
    (_DYNAMIC_LINKING ? PTR_ALIGN_UP((ptr_t)_gp + 0x8000, 0x40000) : (ptr_t)edata)
extern int end[];
#define DATAEND2 ((ptr_t)end)
#endif
#endif
...
#if defined(GC_PTHREADS) || defined(GC_WIN32_THREADS) || ((defined(NN_PLATFORM_CTR) || defined(NINTENDO_SWITCH) || defined(SN_TARGET_PS3) || defined(SN_TARGET_PSP2)) && defined(GC_THREADS))
#define THREADS
#endif
...
#if defined(LINUX) && defined(SPECIFIC_MAIN_STACKBOTTOM) && defined(NO_PROC_STAT) && !defined(USE_LIBC_PRIVATES)
...
#if (defined(E2K) && defined(USE_PTR_HWTAG) || defined(CHERI_PURECAP)) && !defined(NO_BLACK_LISTING)
...
#if defined(REDIRECT_MALLOC) && defined(THREADS) && (defined(LINUX) || defined(NACL))
/* TODO: Unclear if NaCl really needs this. */
#define REDIR_MALLOC_AND_LINUXTHREADS
#endif

#if defined(REDIR_MALLOC_AND_LINUXTHREADS) && !defined(NO_PROC_FOR_LIBRARIES) && !defined(USE_PROC_FOR_LIBRARIES)
...
#if defined(SOLARIS) || defined(DRSNX) || defined(UTS4) || (defined(LINUX) && defined(SPARC))
/* OS has SVR4 generic features.  Probably others also qualify.   */
#define SVR4
#define DATASTART_USES_XGETDATASTART
#endif

#if defined(HAVE_SYS_TYPES_H) || !(defined(__CC_ARM) || defined(GC_NO_TYPES) || defined(OS2) || defined(MSWINCE) || defined(SN_TARGET_PSP2))
EXTERN_C_END
...
#if defined(HAVE_UNISTD_H) || !(defined(GC_NO_TYPES) || defined(MSWIN32) || defined(MSWINCE) || defined(MSWIN_XBOX1) || defined(NINTENDO_SWITCH) || defined(NN_PLATFORM_CTR) || defined(OS2) || defined(SERENITY) || defined(SN_TARGET_PSP2) || defined(__CC_ARM))
EXTERN_C_END
#include <unistd.h>
EXTERN_C_BEGIN
#endif /* HAVE_UNISTD_H */
...
#if defined(DGUX) || defined(HOST_ANDROID) || defined(HOST_TIZEN) || defined(KOS) || defined(SERENITY) || (defined(LINUX) && defined(SPARC))
#define GETPAGESIZE() (unsigned)sysconf(_SC_PAGESIZE)
#else
...
#if (defined(FREEBSD) && (defined(__DragonFly__) || defined(__GLIBC__) || __FreeBSD_kernel__ >= 4 || __FreeBSD__ >= 4)) || defined(HPUX)
#define SUNOS5SIGS
#endif

#if defined(COSMO) || defined(HPUX) || defined(HURD) || defined(NETBSD) || defined(SERENITY) || (defined(FREEBSD) && defined(SUNOS5SIGS)) || (defined(IRIX5) && defined(_sigargs)) /* Irix 5.x, not 6.x */
#define USE_SEGV_SIGACT
/* We may also get SIGBUS. */
#define USE_BUS_SIGACT
#elif defined(ANY_BSD) || defined(HAIKU) || defined(IRIX5) || defined(OSF1) || defined(SUNOS5SIGS)
#define USE_SEGV_SIGACT
#endif
...
#elif defined(GC_PTHREADS) && !defined(GC_PTHREADS_PARAMARK) && !defined(__MINGW32__)
...
#if !defined(NO_MARKER_SPECIAL_SIGMASK) && (defined(NACL) || defined(GC_WIN32_PTHREADS) || (defined(GC_PTHREADS_PARAMARK) && defined(GC_WIN32_THREADS)) || defined(GC_NO_PTHREAD_SIGMASK))
...
#if defined(AIX) || defined(ANY_BSD) || defined(BSD) || defined(COSMO) || defined(DARWIN) || defined(DGUX) || defined(HAIKU) || defined(HPUX) || defined(HURD) || defined(IRIX5) || defined(LINUX) || defined(OSF1) || defined(QNX) || defined(SERENITY) || defined(SVR4)
...
#if defined(ANY_BSD) || defined(DARWIN) || defined(IRIX5) || defined(LINUX) || defined(SERENITY) || defined(SOLARIS) || ((defined(CYGWIN32) || defined(USE_MMAP) || defined(USE_MUNMAP)) && !defined(USE_WINALLOC))
...
#if !defined(DEFAULT_VDB) && !defined(GWW_VDB) && !defined(MPROTECT_VDB) && !defined(PROC_VDB) && !defined(SOFT_VDB) && !defined(GC_DISABLE_INCREMENTAL)
#define DEFAULT_VDB
#endif

#if defined(CHECK_SOFT_VDB) && !defined(CPPCHECK) && (defined(GC_PREFER_MPROTECT_VDB) || !defined(SOFT_VDB) || !defined(MPROTECT_VDB))
#error Invalid config for CHECK_SOFT_VDB
#endif

#if (defined(GC_DISABLE_INCREMENTAL) || defined(BASE_ATOMIC_OPS_EMULATED) || defined(REDIRECT_MALLOC) || defined(SMALL_CONFIG) || defined(REDIRECT_MALLOC_IN_HEADER) || defined(CHECKSUMS)) && !defined(NO_MANUAL_VDB)
...
#if defined(MPROTECT_VDB) && !defined(DONT_COUNT_PROTECTED_REGIONS) && !defined(COUNT_PROTECTED_REGIONS) && (defined(LINUX) || defined(__DragonFly__))
#define COUNT_PROTECTED_REGIONS
#endif

#if (defined(COUNT_PROTECTED_REGIONS) || defined(COUNT_UNMAPPED_REGIONS)) && !defined(GC_UNMAPPED_REGIONS_SOFT_LIMIT)
...
#if (((defined(ARM32) || defined(AVR32) || defined(MIPS) || defined(NIOS2) || defined(OR1K)) && defined(UNIX_LIKE)) || defined(DARWIN) || defined(HAIKU) || defined(HURD) || defined(OPENBSD) || defined(QNX) || defined(RTEMS) || defined(SERENITY) || defined(HOST_ANDROID) || (defined(LINUX) && !defined(__gnu_linux__))) && !defined(NO_GETCONTEXT)
#define NO_GETCONTEXT 1
#endif

#if defined(MSWIN32) && !defined(CONSOLE_LOG) && defined(_MSC_VER) && defined(_DEBUG) && !defined(NO_CRT)
...
#elif defined(_MSC_VER) && !defined(NO_PREFETCH) && (defined(_M_IX86) || defined(_M_X64)) && !defined(_CHPE_ONLY_) && (_MSC_VER >= 1900) /* VS 2015+ */
EXTERN_C_END
#include <intrin.h>
EXTERN_C_BEGIN
...
#if defined(HEURISTIC2) || defined(SEARCH_FOR_DATA_START) || defined(IA64) || defined(DGUX) || defined(FREEBSD) || defined(OPENBSD) || defined(SVR4) || (defined(HPUX) && defined(SPECIFIC_MAIN_STACKBOTTOM)) || (defined(CYGWIN32) && defined(I386) && defined(USE_MMAP) && !defined(USE_WINALLOC)) || (defined(NETBSD) && defined(__ELF__))
...
#if defined(REDIR_MALLOC_AND_LINUXTHREADS) && !defined(HAVE_LIBPTHREAD_SO) && defined(__GLIBC__) && !GC_GLIBC_PREREQ(2, 34)
#define HAVE_LIBPTHREAD_SO
#endif

#if defined(REDIR_MALLOC_AND_LINUXTHREADS) && !defined(INCLUDE_LINUX_THREAD_DESCR)
...
#if !defined(CPPCHECK)
#if defined(GC_AIX_THREADS) && !defined(AIX) || (defined(GC_DARWIN_THREADS) && !defined(DARWIN)) || (defined(GC_DGUX386_THREADS) && !defined(DGUX)) || (defined(GC_FREEBSD_THREADS) && !defined(FREEBSD)) || (defined(GC_HAIKU_THREADS) && !defined(HAIKU)) || (defined(GC_HPUX_THREADS) && !defined(HPUX)) || (defined(GC_IRIX_THREADS) && !defined(IRIX5)) || (defined(GC_LINUX_THREADS) && !defined(LINUX) && !defined(NACL)) || (defined(GC_NETBSD_THREADS) && !defined(NETBSD)) || (defined(GC_OPENBSD_THREADS) && !defined(OPENBSD)) || (defined(GC_OSF1_THREADS) && !defined(OSF1)) || (defined(GC_RTEMS_PTHREADS) && !defined(RTEMS)) || (defined(GC_SOLARIS_THREADS) && !defined(SOLARIS)) || (defined(GC_WIN32_THREADS) && !defined(ANY_MSWIN) && !defined(MSWIN_XBOX1))
...
#if defined(CYGWIN32) && (defined(MPROTECT_VDB) || defined(USE_MUNMAP)) || (!defined(ANY_MSWIN) && !defined(WASI) && !defined(USE_MMAP) && (defined(GC_DISABLE_INCREMENTAL) || defined(DEFAULT_VDB)))
...
#if defined(GC_PTHREADS) && !defined(DARWIN) && !defined(GC_WIN32_THREADS) && !defined(PLATFORM_STOP_WORLD) && !defined(SN_TARGET_PSP2)
...
#if !(defined(GC_PTHREADS) || defined(GC_PTHREADS_PARAMARK) || (defined(MPROTECT_VDB) && defined(DARWIN)))
...
#if defined(PARALLEL_MARK) && !defined(DEFAULT_STACK_MAYBE_SMALL) && (defined(DGUX) || defined(HPUX) || defined(NO_GETCONTEXT) /* e.g. musl */)
...
/* Outline pthread primitives to use in GC_get_[main_]stack_base.       */
     ...
     || defined(COSMO) || defined(HAIKU) || defined(LINUX) || defined(KOS) || defined(NETBSD)) && \
...
#if (defined(HAVE_PTHREAD_ATTR_GET_NP) || defined(HAVE_PTHREAD_GETATTR_NP)) && defined(USE_GET_STACKBASE_FOR_MAIN) && !defined(STACKBOTTOM) && !defined(HEURISTIC1) && !defined(HEURISTIC2) && !defined(STACK_GRAN) && !defined(SPECIFIC_MAIN_STACKBOTTOM)
...
#if defined(GC_PTHREADS) && !defined(E2K) && !defined(IA64) && (!defined(DARWIN) || defined(DARWIN_DONT_PARSE_STACK)) && !defined(SN_TARGET_PSP2) && !defined(REDIRECT_MALLOC)
...
#if !defined(CAN_HANDLE_FORK) && !defined(NO_HANDLE_FORK) && !defined(HAVE_NO_FORK) && ((defined(GC_PTHREADS) && !defined(NACL) && !defined(GC_WIN32_PTHREADS) && !defined(USE_WINALLOC)) || (defined(DARWIN) && defined(MPROTECT_VDB) /* && !THREADS */) || (defined(HANDLE_FORK) && defined(GC_PTHREADS)))
...
#if defined(CYGWIN32) && defined(THREADS) && defined(CAN_HANDLE_FORK) && !defined(CYGWIN_SEM_FIXUP_AFTER_FORK_BUG_FIXED) && !defined(EMULATE_PTHREAD_SEMAPHORE)
...
#if !defined(MSGBOX_ON_ERROR) && !defined(NO_MSGBOX_ON_ERROR) && defined(MSWIN32) && !defined(MSWINRT_FLAVOR) && !defined(MSWIN_XBOX1) && !defined(SMALL_CONFIG)
...
#if defined(SPARC) || ((defined(I386) || defined(X86_64)) && (defined(LINUX) || defined(__GLIBC__)))
