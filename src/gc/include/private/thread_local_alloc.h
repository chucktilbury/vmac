...
#if defined(ARM32) && (GC_GNUC_PREREQ(4, 6) || GC_CLANG_PREREQ_FULL(3, 8, 256229))
#define USE_COMPILER_TLS
...
#elif (defined(COSMO) || defined(FREEBSD) || (defined(NETBSD) && __NetBSD_Version__ >= 600000000 /* 6.0 */)) && (GC_GNUC_PREREQ(4, 4) || GC_CLANG_PREREQ(3, 9))
#define USE_COMPILER_TLS
...
#elif defined(IRIX5) || defined(OPENBSD) || defined(SOLARIS) || defined(NN_PLATFORM_CTR) || defined(NN_BUILD_TARGET_PLATFORM_NX)
