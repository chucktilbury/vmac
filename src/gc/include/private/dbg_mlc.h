...
#if defined(REDIRECT_MALLOC) && defined(THREADS) && defined(DBG_HDRS_ALL) && NARGS == 0 && NFRAMES % 2 == 0 && defined(GC_HAVE_BUILTIN_BACKTRACE)
...
#define GC_HAS_DEBUG_INFO(base) \
    (((GC_uintptr_t)GC_cptr_load((volatile ptr_t*)(base)) & 1) != 0 && GC_has_other_debug_info(base) > 0)
#else
#define GC_HAS_DEBUG_INFO(base) \
